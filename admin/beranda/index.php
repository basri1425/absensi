                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <?php
                                        ...
                                        $sql="select distinct k.kode_kelas,k.nama_kelas from kelas k inner join pertemuan p on p.kelas=k.kode_kelas group by k.kode_kelas,k.nama_kelas order by k.id_kelas asc";
...
<script>
    ...
    function data_harian(){
        ...
        $.ajax({
            ...
            dataType: "html",
            async : false,
            url: 'admin/beranda/data-harian.php',
