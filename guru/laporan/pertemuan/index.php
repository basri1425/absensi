            ...
            <div class="card">
                ...
                <div class="card-body table-full-width table-responsive">
                    <div class="col-sm-12">
                        <div class="row">
                            <div class="col-sm-12">
                                <p>Daftar absensi adalah rangkuman seluruh absensi siswa berdasarkan pertemuan pada kelas dan mata pelajaran tertentu.</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-4">
...
<script>
    ...
    var mapel = $("#mapel").val();
      $.ajax({
          ...
          dataType: "html",
          async : false,
          url: 'guru/laporan/pertemuan/tabel-pertemuan.php',
    ...
    function get_mapel(){
      var kelas=$("#kelas").val();
      $.ajax({
        url: 'guru/laporan/pertemuan/get-mapel.php',
            method : "POST",
            data : {kelas:kelas},
            async : false,
            dataType : 'json',
